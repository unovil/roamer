...
<div class="mx-32">
  <div class="mx-5 mt-20 flex justify-between">
    <div
      class="mr-2 h-screen w-3/4 rounded-md border border-gray-300 p-4 shadow"
    >
    ...
    <div
      class="ml-2 h-screen w-3/4 rounded-md border border-gray-300 p-4 shadow"
    >
      <caption
