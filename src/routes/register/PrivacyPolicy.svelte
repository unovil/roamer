...
<p class="font-bold">Last updated: May 12, 2024</p>
<p>
...
<h2 id="interpretation-and-definitions" class="text-xl font-bold">
  Interpretation and Definitions
</h2>
<h3 id="interpretation" class="font-bold">Interpretation</h3>
<p>
  The words of which the initial letter is capitalized have meanings defined
  under the following conditions. The following definitions shall have the same
  meaning regardless of whether they appear in singular or in plural.
</p>
<h3 id="definitions" class="font-bold">Definitions</h3>
...
<ul>
  <li>
    ...
    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Leo, Pasig City,
    Philippines.
  </li>
</ul>
<ul>
...
<ul>
  <li>
    <p>
      <strong>Website</strong> refers to Roamer, accessible from
      <a href="http://www.roamer.com/">http://www.roamer.com/</a>
    </p>
  </li>
  <li>
    <p>
...
<h2 id="collecting-and-using-your-personal-data" class="text-xl font-bold">
  Collecting and Using Your Personal Data
</h2>
<h3 id="types-of-data-collected" class="text-lg font-bold">
  Types of Data Collected
</h3>
<h4 id="personal-data" class="font-bold">Personal Data</h4>
<p>
...
<h4 id="usage-data" class="font-bold">Usage Data</h4>
...
<h4 id="tracking-technologies-and-cookies" class="font-bold">
...
<h3 id="use-of-your-personal-data" class="text-lg font-bold">
...
<h3 id="retention-of-your-personal-data" class="text-lg font-bold">
...
<h3 id="transfer-of-your-personal-data" class="text-lg font-bold">
...
<h3 id="delete-your-personal-data" class="text-lg font-bold">
...
<h3 id="disclosure-of-your-personal-data" class="text-lg font-bold">
  Disclosure of Your Personal Data
</h3>
<h4 id="business-transactions" class="font-bold">Business Transactions</h4>
<p>
  If the Company is involved in a merger, acquisition or asset sale, Your
  Personal Data may be transferred. We will provide notice before Your Personal
  Data is transferred and becomes subject to a different Privacy Policy.
</p>
<h4 id="law-enforcement" class="font-bold">Law enforcement</h4>
<p>
  Under certain circumstances, the Company may be required to disclose Your
  Personal Data if required to do so by law or in response to valid requests by
  public authorities (e.g. a court or a government agency).
</p>
<h4 id="other-legal-requirements" class="font-bold">
...
<h3 id="security-of-your-personal-data" class="text-lg font-bold">
...
<h2 id="children-s-privacy" class="text-xl font-bold">
  Children&#39;s Privacy
</h2>
<p>
...
<h2 id="links-to-other-websites" class="text-xl font-bold">
...
<h2 id="changes-to-this-privacy-policy" class="text-xl font-bold">
...
<h2 id="contact-us" class="text-xl font-bold">Contact Us</h2>
<p>If you have any questions about this Privacy Policy, You can contact us:</p>
<ul>
  <li>By mail: Pasig City Science High School, Philippines</li>
</ul>
